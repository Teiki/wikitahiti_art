...
public class MessageViewHolder extends RecyclerView.ViewHolder {
	...
	@BindView(R.id.activity_mentor_chat_item_profile_container_is_mentor_image) ImageView imageViewIsCool;
	...
	public void updateWithMessage(Message message, String currentUserId, RequestManager glide){
		...
		// Update isCool ImageView
		this.imageViewIsCool.setVisibility(message.getUserSender().getIsCool() ? View.VISIBLE : View.INVISIBLE);
